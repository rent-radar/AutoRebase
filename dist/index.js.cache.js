...
})(
    {
        ...
        327: function (e, t, r) {
            ...
            class rebaser_Rebaser {
                ...
                async rebase(e) {
                    ...
                    try {
                        ...
                        Object(i.error)(`Error while rebasing for ${JSON.stringify(e)}: ${String(t)}`);
                    }
                }
            }
            ...
            class testableEligiblePullRequestsRetriever_TestableEligiblePullRequestsRetriever {
                ...
                async findEligiblePullRequests(e, t, r) {
                    const n = await this.openPullRequestsProvider.openPullRequests(e, t, r);
                    Object(i.info)(`Found ${n.length} open pull requests against ${r}`);
                    const s = n.filter((e) => {
                        return testableEligiblePullRequestsRetriever_TestableEligiblePullRequestsRetriever.isEligible(
                            e,
                        );
                    });
                    Object(i.info)(`${s.length} pull requests are eligible.`);
                    return s;
                }
                static isEligible(e) {
                    if (e.labels.includes(o)) {
                        Object(i.info)(`PR #${e.number} has the '${o}' label.`);
                        return false;
                    }
                    if (!e.rebaseable) {
            ...
            class GithubListPullRequestsService {
                ...
                async listOpenPullRequests(e, t, r) {
                    const i = this.github.pulls.list.endpoint.merge({owner: e, repo: t, state: 'open', base: r});
                    const n = [];
                    for await (const e of this.github.paginate.iterator(i)) {
                        const t = e.data;
                        n.push(
                            ...t.map((e) => {
            ...
            class githubOpenPullRequestsProvider_GithubOpenPullRequestsProvider {
                ...
                async openPullRequests(e, t, r) {
                    const i = await this.listPullRequestsService.listOpenPullRequests(e, t, r);
                    return await mapAsync(i, async (r) => {
            ...
            async function run() {
                try {
                    ...
                    Object(i.info)(`Received push on ${a.ref}`);
                    const u = a.repository.owner.login;
                    const p = a.repository.name;
                    const c = a.ref.split('/').slice(-1)[0];
                    const d = await r.findEligiblePullRequests(u, p, c);
                    await s.rebasePullRequests(d);
                    await o.createOptOutLabel(u, p);
                } catch (e) {
        ...
        854: function (e) {
            ...
            var P = C ? C.prototype : undefined,
                R = P ? P.toString : undefined;
            function Hash(e) {
                var t = -1,
                    r = e ? e.length : 0;
                this.clear();
